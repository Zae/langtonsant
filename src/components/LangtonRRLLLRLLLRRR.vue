...
class RRLLLRLLLRRRAnt extends Ant
{
    getNewState(grid) {
        return (grid[this.position[0]][this.position[1]] + 1) % 12;
    }
...
let grid = [];
let ctx = null;
const ant = new RRLLLRLLLRRRAnt(TYPE_DIRECTION_UP, [
    ...
    methods: {
        ...
        renderCell(y, x) {
            ...
            case STATE_8:
                ...
                break;
            case STATE_9:
                ctx.fillStyle = '#8b7ec4';
                ctx.fillRect(x * pixelSize, y * pixelSize, pixelSize, pixelSize);
                break;
            case STATE_10:
                ctx.fillStyle = '#44133d';
                ctx.fillRect(x * pixelSize, y * pixelSize, pixelSize, pixelSize);
                break;
            case STATE_11:
                ctx.fillStyle = '#505d36';
                ctx.fillRect(x * pixelSize, y * pixelSize, pixelSize, pixelSize);
                break;
            case STATE_12:
